  ...
  return (
    <>
      <Card>
        ...
        <NavRow icon={Heart} label="Support Nearside" onClick={() => setShowSupport(true)} />
        <NavRow icon={Scale} label="Open source licenses" onClick={() => setShowLicenses(true)} />
        <NavRow icon={FileText} label="Terms of Service" onClick={() => setLegalDoc('terms')} />
        <NavRow icon={Lock} label="Privacy Policy" onClick={() => setLegalDoc('privacy')} />
      </Card>
